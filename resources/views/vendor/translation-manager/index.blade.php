...
<head>
    ...
    <title>Tagxi-Delivery | Taxi Dispatch Software/System, Carpool Software App for Android &amp; iOS</title>
                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <form role="form" method="POST" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postAddGroup') ?>">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-default btn-sm" name="add-group" value="Add and edit keys" />
                            </div>
                        </form>
                        <?php if ($group) : ?>
                            <form action="<?php echo action('\Barryvdh\TranslationManager\Controller@postAdd', array($group)) ?>" method="POST" role="form">
                                ...
                                <div class="form-group">
                                    <input type="submit" value="Add keys" class="btn btn-primary btn-sm">
                                </div>
                            </form>
                            <div class="row">
                                <div class="col-sm-2">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($translations as $key => $translation) : ?>
                                        <tr id="<?php echo htmlentities($key, ENT_QUOTES, 'UTF-8', false) ?>">
                                            ...
                                            <?php if ($deleteEnabled) : ?>
                                                <td>
                                                    <a href="<?php echo action('\Barryvdh\TranslationManager\Controller@postDelete', [$group, $key]) ?>" class="delete-key" data-confirm="Are you sure you want to delete the translations for '<?php echo htmlentities($key, ENT_QUOTES, 'UTF-8', false) ?>?"><span class="glyphicon glyphicon-trash"></span></a>
                                                </td>
                                            <?php endif; ?>
                                        </tr>
                                    <?php endforeach; ?>
