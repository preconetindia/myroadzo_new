                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="vehicle_make_name" name="vehicle_make_name"
                                                value="{{ old('vehicle_make_name') }}" required
                                                placeholder="@lang('view_pages.enter') @lang('view_pages.vehicle_make_name')">
                                            <span class="text-danger">{{ $errors->first('vehicle_make_name') }}</span>
                                        </div>
                                    </div>
                                      <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="vehicle_make_for" id="vehicle_make_for" class="form-control" required>
                                                ...
                                                <option value="truck" {{ old('vehicle_make_for') == 'truck' ? 'selected' : '' }}>@lang('view_pages.truck')</option>
