...
<div class="col-sm-12">
    <div class="box">
        ...
        <div class="box-header with-border">
          <a href="{{ url('vehicle_fare/rental_package/index',$item->zone_type_id) }}">
...
<form  method="post" class="form-horizontal" action="{{url('vehicle_fare/rental_package/update',$item->id)}}" enctype="multipart/form-data">
@csrf
